...
//    private int[] splitOptions = { 1, 2, 4, 8, 16, 32, 64, 128 };
//    private string[] splitOptionsDisplay = { "1", "2", "4", "8", "16", "32", "64", "128" };
...
//                            }
//                            canvas.Save();
//                            Directory.CreateDirectory(sourcePath.Substring(0, sourcePath.Length - 4));
